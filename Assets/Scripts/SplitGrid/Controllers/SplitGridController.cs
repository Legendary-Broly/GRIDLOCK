...
namespace SplitGrid.Controllers
{
    public class SplitGridController : MonoBehaviour
    {
        ...
        private void HandleRightClick(GridID gridId, int x, int y)
        {
            ...
            bool isVirus = gridId == GridID.GridA ? 
                virusServiceA.HasVirusAt(x, y) : 
                virusServiceB.HasVirusAt(x, y);

            splitGridService.SetVirusFlag(gridId, x, y, isVirus);
            ...
            splitGridService.DisableVirusFlag(gridId);
        }
